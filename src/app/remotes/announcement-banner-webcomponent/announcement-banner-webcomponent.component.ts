...
@Component({
  selector: 'app-announcement-banner-webcomponent',
  standalone: true,
  ...
  templateUrl: './announcement-banner-webcomponent.component.html'
})
export class OneCXAnnouncementWebcomponentBannerComponent implements ocxRemoteComponent, ocxRemoteWebcomponent {
